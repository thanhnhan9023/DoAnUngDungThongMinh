...
namespace DALL_BALL
{
    ...
    partial void InsertQuanTriNguoiDung(QuanTriNguoiDung instance);
    partial void UpdateQuanTriNguoiDung(QuanTriNguoiDung instance);
    partial void DeleteQuanTriNguoiDung(QuanTriNguoiDung instance);
    #endregion
		...
		public System.Data.Linq.Table<QuanTriNguoiDung> QuanTriNguoiDungs
		{
			get
			{
				return this.GetTable<QuanTriNguoiDung>();
			}
		}
	}
    ...
    partial void OnDonViChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MAHD_Xuat", DbType="VarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
	...
	public partial class ChucVu : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<QuanTriNguoiDung> _QuanTriNguoiDungs;
    ...
    partial void OnLCBChanged();
		...
		public ChucVu()
		{
			...
			this._QuanTriNguoiDungs = new EntitySet<QuanTriNguoiDung>(new Action<QuanTriNguoiDung>(this.attach_QuanTriNguoiDungs), new Action<QuanTriNguoiDung>(this.detach_QuanTriNguoiDungs));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ChucVu_QuanTriNguoiDung", Storage="_QuanTriNguoiDungs", ThisKey="MaCv", OtherKey="MaCV")]
		public EntitySet<QuanTriNguoiDung> QuanTriNguoiDungs
		{
			get
			{
				return this._QuanTriNguoiDungs;
			}
			set
			{
				this._QuanTriNguoiDungs.Assign(value);
			}
		}
		...
		private void attach_QuanTriNguoiDungs(QuanTriNguoiDung entity)
		{
			this.SendPropertyChanging();
			entity.ChucVu = this;
		}
		
		private void detach_QuanTriNguoiDungs(QuanTriNguoiDung entity)
		{
			this.SendPropertyChanging();
			entity.ChucVu = null;
		}
    ...
    partial void OnTinhTrangNhapChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MaNC", DbType="VarChar(50)")]
		public string MaNC
		{
			get
			{
    ...
    partial void OnTenmanhinhChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Tenmanhinh", DbType="NChar(10)")]
	...
	public partial class NguoiDung : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<QuanTriNguoiDung> _QuanTriNguoiDung;
    ...
    partial void OnMaNVChanged();
		...
		public NguoiDung()
		{
			this._QuanTriNguoiDung = default(EntityRef<QuanTriNguoiDung>);
			this._NhanVien = default(EntityRef<NhanVien>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NguoiDung_QuanTriNguoiDung", Storage="_QuanTriNguoiDung", ThisKey="UserName", OtherKey="UserName", IsUnique=true, IsForeignKey=false)]
		public QuanTriNguoiDung QuanTriNguoiDung
		{
			get
			{
				return this._QuanTriNguoiDung.Entity;
			}
			set
			{
				QuanTriNguoiDung previousValue = this._QuanTriNguoiDung.Entity;
				if (((previousValue != value) 
							|| (this._QuanTriNguoiDung.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._QuanTriNguoiDung.Entity = null;
						previousValue.NguoiDung = null;
					}
					this._QuanTriNguoiDung.Entity = value;
					if ((value != null))
					{
						value.NguoiDung = this;
					}
					this.SendPropertyChanged("QuanTriNguoiDung");
				}
			}
		}
    ...
    partial void OnTrangthaiChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MaNC", DbType="VarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string MaNC
		{
			get
			{
    ...
    partial void OnTinhTrangChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NhanVien_QuanTriNguoiDung", Storage="_QuanTriNguoiDungs", ThisKey="MANV", OtherKey="MANV")]
		public EntitySet<QuanTriNguoiDung> QuanTriNguoiDungs
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.QuanTriNguoiDung")]
	public partial class QuanTriNguoiDung : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnID_IChanging(string value);
    ...
    partial void OnMaCVChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ID_I", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		public string ID_I
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ChucVu_QuanTriNguoiDung", Storage="_ChucVu", ThisKey="MaCV", OtherKey="MaCv", IsForeignKey=true)]
		public ChucVu ChucVu
		{
			get
			{
			...
			set
			{
							...
							|| (this._ChucVu.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._ChucVu.Entity = null;
						previousValue.QuanTriNguoiDungs.Remove(this);
					}
					this._ChucVu.Entity = value;
					if ((value != null))
					{
						value.QuanTriNguoiDungs.Add(this);
						this._MaCV = value.MaCv;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NguoiDung_QuanTriNguoiDung", Storage="_NguoiDung", ThisKey="UserName", OtherKey="UserName", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._NguoiDung.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.QuanTriNguoiDung = null;
					}
					this._NguoiDung.Entity = value;
					if ((value != null))
					{
						value.QuanTriNguoiDung = this;
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NhanVien_QuanTriNguoiDung", Storage="_NhanVien", ThisKey="MANV", OtherKey="MANV", IsForeignKey=true)]
		public NhanVien NhanVien
		{
			get
			{
